<div class="banner" id="slides">
    <div class="slides_container">
        <div class="oneSlide" style="background:#fce43e url(../public/images/slide1.jpg) scroll no-repeat 0 0; ">
            <div class="text">
                <h1>Epilacija, nešto sasvim novo kod nas</h1>
            </div>
        ...
        <div class="oneSlide" style="background:#f4f45b url(../public/images/slide4.jpg) scroll no-repeat 0 0; display:none;">
            ...
            <img src="../public/images/lice.png" />
        </div>
    </div>
</div>
<script>
